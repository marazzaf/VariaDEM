...
pos_bary_cells = position_ddl_cells(mesh,d)
vertex_associe_face,pos_ddl_vertex,num_ddl_vertex_ccG = dico_position_vertex_bord(mesh, facet_num, nb_dof_cells, d, dim)
nb_dof_ccG = nb_dof_cells + d * len(pos_ddl_vertex)
